...
internal class Database private constructor(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    companion object {
        ...
        private const val DATABASE_CREATE = "create table if not exists $TABLE_NAME (timestamp long primary key, pType TEXT CHECK( pType IN ('M','R','H') )   NOT NULL DEFAULT 'M', steps int not null);"
